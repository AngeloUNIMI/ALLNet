...
class vgg16_bn_Mahdi_lbcnn(nn.Module):

    def __init__(self, numClasses):
        super(vgg16_bn_Mahdi_lbcnn, self).__init__()
        in_channels = 3

        self.features = nn.Sequential(

            # nn.Conv2d(in_channels, 32, kernel_size=7, padding=1),
            lbcnn_model.ConvLBP(in_channels, 32, kernel_size=7, sparsity=0.5),
            ...
            lbcnn_model.ConvLBP(32, 32, kernel_size=6, sparsity=0.5),
            nn.ReLU(inplace=True),
            nn.BatchNorm2d(32), #or 1d?
            nn.MaxPool2d(kernel_size=2, stride=2, padding=1, dilation=1, ceil_mode=False),

            # nn.Conv2d(32, 128, kernel_size=5, padding=1),
            lbcnn_model.ConvLBP(32, 128, kernel_size=5, sparsity=0.5),
            nn.ReLU(inplace=True),
            ...
            lbcnn_model.ConvLBP(128, 256, kernel_size=5, sparsity=0.5),
            nn.ReLU(inplace=True),
            nn.BatchNorm2d(256), #or 1d?
            nn.MaxPool2d(kernel_size=2, stride=2, padding=1, dilation=1, ceil_mode=False),

            # nn.Conv2d(256, 128, kernel_size=7, padding=1),
            lbcnn_model.ConvLBP(256, 128, kernel_size=7, sparsity=0.5),
            nn.ReLU(inplace=True),
            nn.BatchNorm2d(128), #or 1d?
            nn.MaxPool2d(kernel_size=2, stride=2, padding=1, dilation=1, ceil_mode=False),
            #nn.Dropout2d(0.4),
            ...
            lbcnn_model.ConvLBP(128, 256, kernel_size=3, sparsity=0.5),
            nn.ReLU(inplace=True),
            nn.BatchNorm2d(256), #or 1d?
